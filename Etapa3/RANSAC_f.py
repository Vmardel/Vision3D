...
def dibujar_lineas(imagen1_path, imagen2_path, pts1, pts2, F, inliers, num_lineas=10, mostrar_epipolos=True):
    ...
    # Cargar y corregir orientación EXIF (lo sigo dejando porque no influye en el resultado final pese a que ya no es necesario porque cambiamos las imagenes)
    ...
    plt.tight_layout()
    plt.savefig("data/epipolar_fig1.png")
    plt.close(fig1)
    ...
    plt.subplots_adjust(wspace=0.05)
    plt.tight_layout()
    plt.savefig("data/epipolar_fig2.png")
    plt.close(fig2)
...
if __name__ == "__main__":
    ...
    dibujar_lineas("Imagenes/left1.png", "Imagenes/right1.png", pts1, pts2, F, inliers, num_lineas=10)