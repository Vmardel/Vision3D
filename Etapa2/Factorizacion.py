...
if __name__ == "__main__":
    ...
    P = np.load("/mnt/c/Users/vicen/Documents/GitHub/Vision3D/Etapa1/data/P.npy")
    ...
    np.save("data/K_intrinseca.npy", K)
    np.save("data/R_rotacion.npy", R)
    np.save("data/t_traslacion.npy", t)
